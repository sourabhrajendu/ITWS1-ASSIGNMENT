...
class LPSsolver():
    ...
    def solve(self,a,b,c):
        ...
        fig.legend(linecon+[znormal,zmax],linename+['Z at each Iteration','Maximum Z'],loc='upper center',prop={'size':12},fancybox=True,shadow=True,ncol=5,title='SIMPLEX METHOD').get_frame().set_alpha(0.5)
